...
test_p_value = pd.read_csv('../generate_P_value/p_train.csv')
...
print(dtrain_12.shape)
print(dlabel_12.shape)

smote_tomek = SMOTETomek(random_state = 27)
X_resampled, y_resampled = smote_tomek.fit_sample(dtrain_12, dlabel_12)
...
sub.to_csv('./sbumit_d12_SMOTE.csv', index=False, encoding='utf-8')