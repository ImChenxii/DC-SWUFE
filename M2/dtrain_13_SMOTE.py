...
print(dtrain_13.shape)
print(dlabel_13.shape)

smote_tomek = SMOTETomek(random_state = 27)
X_resampled, y_resampled = smote_tomek.fit_sample(dtrain_13, dlabel_13)
...
sub.to_csv('./sbumit_d13_SMOTE.csv', index=False, encoding='utf-8')